...
from inpainting.pipeline_diffueraser import StableDiffusionDiffuEraserPipeline
...
class DiffuEraser:
    def __init__(
            ...
            pcm_path="weights/PCM_Weights", revision=None,
        ...
        if loaded != (ckpt + mode):
            self.pipeline.load_lora_weights(
                self.pcm_path, weight_name=PCM_ckpts, subfolder=mode
            )
            loaded = ckpt + mode
